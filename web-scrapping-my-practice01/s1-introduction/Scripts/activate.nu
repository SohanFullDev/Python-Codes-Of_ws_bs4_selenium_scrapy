...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\draft\etc-resources\web-scrapping\web-scrapping-my-practice01\s1-introduction'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\draft\etc-resources\web-scrapping\web-scrapping-my-practice01\s1-introduction\Scripts\deactivate.nu'
