...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\draft\etc-resources\web-scrapping\web-scrapping-my-practice01\s2-introduction to bs4'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\draft\etc-resources\web-scrapping\web-scrapping-my-practice01\s2-introduction to bs4\Scripts\deactivate.nu'
